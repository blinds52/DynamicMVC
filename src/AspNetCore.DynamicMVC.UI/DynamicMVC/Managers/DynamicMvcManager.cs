...
namespace AspNetCore.DynamicMVC.UI.DynamicMVC.Managers
{
    ...
    public class DynamicMvcManager : IDynamicMvcManager
    {
        ...
        public DynamicMvcManager(IDynamicEntityMetadataManager dynamicEntityMetadataManager, INavigationPropertyManager navigationPropertyManager, IServiceProvider serviceProvider)
        {
        ...
        //    var firstRoute = routeCollection.OfType<IRouter>().First();
        ...
        {
            using (var dynamicRepository = _serviceProvider.GetRequiredService<IDynamicRepository>())
            {
        ...
        public object GetItemByTypeAndKeyFunction(Type type, dynamic keyValue)
        {
            ...
            using (var dynamicRepository = _serviceProvider.Resolve<IDynamicRepository>())
            {
