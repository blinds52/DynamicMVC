...
namespace DynamicMVC.DynamicEntityMetadataLibrary.Models
{
    public class DynamicMethod
    {
        ...
        public void InvokePreSaveOperation(dynamic id, FormCollection formCollection, dynamic model,ref string returnUrl, IDictionary<string, object> tempData, IDictionary<string, object> viewData)
        {
        ...
        public void InvokePostSaveOperation(dynamic id, FormCollection formCollection, dynamic model,ref string returnUrl, IDictionary<string, object> tempData, IDictionary<string, object> viewData)
        {
